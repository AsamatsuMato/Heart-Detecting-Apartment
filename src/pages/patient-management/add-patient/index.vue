	...
	<view class="add_patient">
		<view class="patient_info">
            ...
            <view class="item">
                ...
                <input v-model="patientInfo.idCard" type="idcard" placeholder="请输入患者证件号码" @blur="checkIdCard">
            </view>
            <view class="item">
                <view class="label" style="margin-right: 70rpx;">出生日期</view>
                <picker mode="date" :value="patientInfo.birthday" :start="startDate" :end="endDate" @change="bindDateChange">
                    <view class="uni-input">{{patientInfo.birthday}}</view>
                </picker>
            </view>
            <view class="item">
                <view class="label">手机号码</view>
                <input v-model="patientInfo.phone" type="number" placeholder="请输入手机号码" @blur="checkPhone">
            </view>
            <view class="item">
                <view class="label">住址</view>
                <textarea v-model="patientInfo.address" auto-height :maxlength="-1" placeholder="请输入就诊人住址"></textarea>
            </view>
        </view>
